...
<div class="art-box art-sheet">
 ...
 <table border="8" height="500" width="500" align="center" style="font-size:13pt;">
 <?php
 $query="select * from doc_tab";
 $sql_query=mysqli_query($conn,$query);
 while($row=mysqli_fetch_array($sql_query))
 {
  if($row['email']==$_GET['email'])
  {
   echo "<tr><td>DOCID</td><td>".$row['docid']."</td></tr>";  
   echo "<tr><td>Name</td><td>".$row['dname']."</td></tr>";  
   ...
   echo "<tr><td>AvailTime</td><td>".$row['availtime']."</td></tr>";
   echo "<tr><td>AvailDays</td><td>".$row['availdays']."</td></tr>"; 
  }
 }
 ?>
 </table>
