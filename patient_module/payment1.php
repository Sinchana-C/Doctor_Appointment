 ...
 $sql_query4=mysqli_query($conn,$query4);
 ...
 {
  $query="INSERT INTO pay_tab(name,email,docid,appid,amount,cardno,cardtype) VALUES('$name','$email','$docid','$appid','$amount','$cardno','$cardtype')";
  $sql_query=mysqli_query($conn,$query);
  $query2="INSERT INTO app_tab(appid,name,email,docid,dname,venue,appdate,appday,apptime,hospital) VALUES('$appid','$name','$email','$docid','$dname','$venue','$appdate','$appday','$apptime','$hospital')";
  $sql_query2=mysqli_query($conn,$query2);
