...
<!-- background table --/><!-->
 ...
 <div style="position:absolute;left:200pt;top:60pt;font-size:22pt;color:pink">
 <?php
 include "connect.php";
 ...
 ?>
 APPID:<?php echo "<div style='position:absolute;left:100pt;top:0pt;color:pink;'>".$appid."</div>"?><br>
 <hr width="550"/>
