...
<div class="cleared reset-box"></div>
 ...
 while($row=mysqli_fetch_array($sql_query))
 {
  ...
  echo "<div style='position:absolute;top:20pt;left:30pt;font-size:22pt;color:pink ;'>Welcome : ".$row['name']."</div>";
 }
 ?><br><br>
...
<div style='position:absolute;top:75pt;left:565pt;font-size:18pt;color:green;'><input type="submit" value="Check Availability" onclick="myFunction()"/></div>
 ...
 if($date[0]!="select date"){?>
 <div style='position:absolute;top:100pt;left:400pt;font-size:18pt;color:blue;font-weight:bold'><?php echo $date[0]." @ ".$date[1]; ?></div>
 ...
 {
  $day="0";?>
  <div style='position:absolute;top:100pt;left:149pt;font-size:18pt;color:pink;font-weight:bold'><?php
