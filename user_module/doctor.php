...
<div style="position:absolute;top:450pt;left:255pt;font-size:18pt;color:red;font-weight:bold" id="fail">
<?php
if($_GET['con']=="1")
...
<div class="art-header">
        <div class="art-header-position">
            <div class="art-header-wrapper">
                ...
                <div class="art-logo"><table><tr>
				<td>
<img src="images/img7.png" width="100" height="100"/></td>
                                 <td><h1 class="art-logo-name" ><a href="#" >&nbsp;&nbsp;&nbsp;&nbsp;E-Health Care System</a></h1>
                                                 <h2 class="art-logo-text"> Doctor Appointment</h2></td>
												 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/img1.jpg" width="100" height="100"/></td></tr></table>
                                </div>
                </div>
            </div>
        </div>
...
<div class="art-nav-inner">
	<ul class="art-hmenu">
		<li>
			<a href="genhome.php" class="active">home</a>
		</li>	
	</ul>
</div>
</div>
...
<td ><input type="checkbox" value="Monday" name="day[]"/>Monday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="Tuesday" name="day[]"/>Tuesday<br>
<input type="checkbox" value="Wednesday" name="day[]"/>Wednesday<input type="checkbox" value="Thursday" name="day[]"/>Thursday<br>
<input type="checkbox" value="Friday" name="day[]"/>Friday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="Saturday" name="day[]"/>Saturday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><input type="checkbox" value="Sunday" name="day[]"/>sunday</td>
