...
<div class="cleared reset-box"></div>
 ...
 <br><br><br>
 <form action="searchspl.php?con=1" method="POST" name="reg">
 ...
 <td><input type="submit" value="SEARCH" onclick="validate()"/></td></tr>
 </table>
 </form>
...
{ ?>
 ...
 <table align="center" border="5" style="font-size:9pt;font-weight:bold;">
 ...
 <?php if($spl==$spl2){ ?><tr><td><a style="color:#FFFF00" href="login.php?con=5&status=send"><?php echo $row["dname"] ?></a></td>
