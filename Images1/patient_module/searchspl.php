...
<div class="cleared reset-box"></div>
 ...
 while($row=mysql_fetch_array($sql_query))
 {
  ...
  echo "<div style='position:absolute;top:10pt;left:0pt;font-size:22pt;color:red;'>Welcome : ".$row['name']."</div>";
 }
...
{ ?>
 ...
 <div align="right" style='Font-Size:16pt;color:red;'><blink>click on DOCTOR NAME to check availability and book appoinment</blink></div>
 ...
 <?php while($row=mysql_fetch_array($sql_query))
 {
  $spl2=$row["specialist"];
 ?>
